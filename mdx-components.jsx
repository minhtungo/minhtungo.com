...
const Heading = {
  ...
  H3: ({ children }) => <h3 className='text-lg text-black dark:text-gray-50 md:text-xl lg:text-2xl'>{children}</h3>,
};

const p = ({ children }) => (
  <Text variants={PopUpFromBottom} className='mt-2 mb-6 text-gray-900 dark:text-gray-200'>
    {children}
  </Text>
);

const ul = ({ children }) => <ul className='mt-4 mb-6 list-disc pl-6'>{children}</ul>;
