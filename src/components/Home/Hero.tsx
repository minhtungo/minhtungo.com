  ...
  return (
    <div className='h-screen flex-1 gap-12 pt-8 md:flex md:items-center md:justify-between lg:pt-0'>
      ...
      <div className='relative -mt-14 basis-3/5 text-center md:text-start'>
        <Image className='absolute -top-4 h-auto w-auto animate-pulse sm:-top-[3rem] sm:left-[10%] md:left-0 md:-top-20 ' src='/static/images/sparkles.svg' alt='sparkles' width={60} height={60} />

        <Text className='mb-[5px] pl-[3px]' variants={PopUpFromBottom}>
          Hi, I am
        </Text>
        <Text variants={PopUpFromBottom}>
          <Heading variant='gradient' size='lg' weight='bold' className='primary-gradient inline pb-2'>
            Minh Tu Ngo.
          </Heading>
        ...
        <Text variants={PopUpFromBottom} className='lg:text-md mt-4 text-sm dark:text-neutral-400 md:text-base lg:ml-[1px] lg:mt-3'>
          ...
          <Link href='/guestbook' className='primary-gradient bg-clip-text text-transparent'>
            guestbook
          </Link>
          !
        </Text>
