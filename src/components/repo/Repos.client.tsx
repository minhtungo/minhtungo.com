...
const RepoItem = ({ repo: { title, description, href, techs } }: { repo: Repo }) => {
  return (
    <div className='relative transition-all group'>
      ...
      />
      <Card className='p-3 border shadow-sm border-border/65 bg-muted/10 rounded-lg grid duration-200 ease-in group-hover:bg-accent/10 group-hover:shadow-lg space-y-2'>
