...
const Contact = ({ home }: { home?: boolean }) => {
  return (
    <div className={mergeClassNames('relative', home && 'pt-16 lg:pt-20')}>
      ...
      <Title title={home ? 'Get In Touch' : 'Contact'} subtitle={home ? '' : "Let's connect"} home={home} className={home ? '!mb-6' : 'lg:!mb-3'} />
      <div className='relative'>
        <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
          <div>
            <div>
              <Text variants={PopUpFromBottom} className='text-sm font-light text-gray-700 dark:text-gray-400 md:text-base'>
            ...
            <div className='mt-8 mb-6 inline-flex flex-col space-y-4'>
              <Link href='mailto:mn.minhtungo@gmail.com' className='flex flex-row items-center space-x-4 hover:text-blue-500'>
                <div className='flex h-9 w-9 items-center justify-center rounded-full bg-gray-300 dark:bg-transparent-white'>
                  <Email className='h-4 w-4 ' />
                </div>
                <p className='text-sm font-light text-gray-800 dark:text-gray-300'>mn.minhtungo@gmail.com</p>
              </Link>
              <Link href='tel:613-453-6449' className='flex flex-row items-center space-x-4 hover:text-blue-500'>
                <div className='flex h-9 w-9 items-center justify-center rounded-full bg-gray-300 dark:bg-transparent-white'>
                  <MdOutlinePhone className='h-4 w-4' />
                </div>
                <p className='text-sm font-light text-gray-800 dark:text-gray-300'>613-453-6449</p>
              </Link>
            </div>
            {/* Info */}
